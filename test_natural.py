...
names = np.array(['balloon', 'book', 'calendar', 'clock', 'corner', 'craft', 'desk', 'flower',
                  'girl', 'grass', 'lab', 'leaf', 'leopard', 'newspaper', 'pepsi', 'seascape', 'temple', 'wine'])
# num = 1
win_size = 7   # filter size

for num in range(0, 18):
    original_path1 = '/media/gdlls/My Book/Root/QZZ/code/DRL-FPD/sourceimages/naturalDatasets/{}1.bmp'.format(names[num])
    original_path2 = '/media/gdlls/My Book/Root/QZZ/code/DRL-FPD/sourceimages/naturalDatasets/{}2.bmp'.format(names[num])
    ...
    imageio.imwrite('/media/gdlls/My Book/Root/QZZ/code/DRL-FPD/results_natural/{}_natural.tif'.format(names[num]), FF[:,:,0])
    toc = time.time()
