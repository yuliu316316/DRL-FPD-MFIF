...
for num in range(1, 14):
    original_path1 = '/media/gdlls/My Book/Root/QZZ/code/DRL-FPD/sourceimages/MFFW/mffw_{}{}_A.jpg'.format(num//10, num % 10)
    original_path2 = '/media/gdlls/My Book/Root/QZZ/code/DRL-FPD/sourceimages/MFFW/mffw_{}{}_B.jpg'.format(num//10, num % 10)
    ...
    imageio.imwrite('/media/gdlls/My Book/Root/QZZ/code/DRL-FPD/results_mffw/mffw_{}{}.tif'.format(num//10, num % 10), FF)
    toc = time.time()
